...
// ลูกค้าอัปโหลดสลิป (public) — ครอบ rate limiter
router.post(
  '/room/upload-slip',
  publicRateLimit,
  uploadSlip.single('slip'),
  roomCtrl.uploadSlipRoom
);
...
router.get('/banquet/:id/slip-url', requireAdminAuth, banquetCtrl.viewSlipBanquetAdmin);
